...
#     @pup = Pup.new(pup_params)
  ...
  private
    ...
    def pup_params
      params.require(:pup).permit(:name, :breed, :weight, :gender, :birthday, :picture, :tracking_chip, :neutered, :good_w_dogs, :special_requirements, :care_instructions, :vet_phone)
    end
end
